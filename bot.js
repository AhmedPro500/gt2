...
client.user.setGame("-help -invite|By GTA", "https://www.twitch.tv/alpha");
});
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            .setDescription(`**__ticketbot and rainbow | by GTA__ 
...
client.login('NTcwOTk3MTAzMjk2NTEyMDUz.XMHUhg.CH3EAsqJlS0czK2cht4BL-QFUNM');
